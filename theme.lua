...
theme.font          = "Roboto Mono Nerd Complete 8"
theme.icon_font     = "Roboto Mono Nerd Complete 12"
...
theme.titlebar_bg_focus = "#434c5e"
...
theme.wallpaper = config_path .."wallpapers/tokyo_wave.jpg"
